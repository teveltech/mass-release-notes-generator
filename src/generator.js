...
function generate(title, repository, fromRef, toRef, githubToken) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, owner, repo, octokit, commits, releaseNotes, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    error_1 = _b.sent();
                    return [2 /*return*/, "Action failed with error " + error_1];
